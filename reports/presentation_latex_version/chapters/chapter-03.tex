	...
	\begin{center}
        \begin{minipage}{0.6\textwidth} % Adjust the width of the block
            \begin{block}{} % Empty block title
                \centering
                {\large \textbf{Appendix - Literature Review}} % Slightly smaller text
            \end{block}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
		...
		\caption{\tiny Figure 18: Systematic Overview about main theoretical approaches.\footnote{Own Illustration based on Figure 5, page 5, \cite{oberndorfer_2020_oil_prices_exchange_rates}, full list provided in the References section.}\label{fig:chap_03_literature_systematic_overview}}
        \nocite{fama2016commodity}
        \nocite{han2025drives}
        \nocite{wang2023commodity}
        \nocite{evgenidis2018all}
        \nocite{charles2012exchange}
        \nocite{qiao2023international}
        \nocite{salem2024volatility}
        \nocite{bollen2000regime}
        \nocite{basher2016impact}
        \nocite{boubakri2019non}
        \nocite{fratzscher2014oil}
        \nocite{aloui2014dependence}
        \nocite{antonio2022inflation}
        \nocite{lizardo2010oil}
    \end{figure}
\end{frame}