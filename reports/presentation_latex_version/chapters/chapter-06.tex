...
\end{frame}
%----------------------------------------------------------------------------------------
\subsection{Spot exchange rate distributions}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Spot exchange rate distributions (raw data - normalized)}
    \begin{figure}
		\includegraphics[width=0.7\linewidth]{chap_06_raw_data_normalized_histogram.pdf}
		\caption{\tiny Figure: Normalized daily EUR/USD spot exchange rate, oil and gas over the time range: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap_06_raw_data_normalized_histogram}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Spot exchange rate distributions (log first differences)}
    \begin{figure}
		\includegraphics[width=0.7\linewidth]{chap_06_log_first_diff_histogram.pdf}
		\caption{\tiny Figure: Log first differences of daily EUR/USD spot exchange rate, oil and gas over the time range: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap_06_log_first_diff_histogram}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
    ...
    \begin{table}
        ...
        \resizebox{\textwidth}{!}{
            \begin{tabular}{llrrrrl}
                \toprule
                \textbf{Variable} & \textbf{Test} & \textbf{Statistic} & \textbf{p-value} & \textbf{Significance-level} & \textbf{p-value < 0.05} & \textbf{Result} \\
                \midrule
        ...
        \caption{\tiny Table: Shapiro-Wilks, Kolmogorov-Smirnov, D'Agostino's $K^2$ test for normality for the EUR/USD spot exchange rate, WTI Oil and Natural Gas daily observations over the time 1999 - 2025.\footnote{See: XXX}}
    \end{table}
\end{frame}
%----------------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{table}
        ...
        \caption{\tiny Table: Augmented-Dickey-Fuller (ADF) test for stationarity in various variants for the EUR/USD spot exchange rate, WTI Oil and Natural Gas daily observations over the time 1999 - 2025.\footnote{See: XXX}}
    \end{table}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
...
\begin{frame}
    ...
    \begin{table}
        ...
        \caption{\tiny Table: Augmented-Dickey-Fuller (ADF) test for stationarity in various variants for the EUR/USD spot exchange rate, WTI Oil and Natural Gas daily observations (log first differences) over the time 1999 - 2025.\footnote{See: XXX}}
    \end{table}
\end{frame}
%----------------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{table}
        ...
        \caption{\tiny Table: Engle and Granger Cointegration test for the EUR/USD spot exchange rate, WTI Oil and Natural Gas daily observations over the time 1999 - 2025.\footnote{See: XXX}}
    \end{table}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
...
\begin{frame}
    ...
    \caption{\tiny Table: Engle and Granger Cointegration test for the EUR/USD spot exchange rate, WTI Oil and Natural Gas daily observations (log first differences) over the time 1999 - 2025.\footnote{See: XXX}}
    \end{table}
\end{frame}
%----------------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{figure}
		\includegraphics[width=0.7\linewidth]{chap06_acf_plot_raw_series.pdf}
		\caption{\tiny Figure: ACF values for daily observations of the EUR/USD spot exchange rate, oil and gas over the time: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap06_acf_plot_raw_series}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
...
\begin{frame}
    ...
    \begin{figure}
		\includegraphics[width=0.7\linewidth]{chap06_acf_plot_log_diff.pdf}
		\caption{\tiny Figure: ACF values for daily observations (log first differences) of the EUR/USD spot exchange rate, WTI Oil and Natural Gas over the time: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap06_acf_plot_log_diff}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{figure}
		\includegraphics[width=0.7\linewidth]{chap06_pacf_plot_raw_series.pdf}
		\caption{\tiny Figure: PACF values for daily observations of the EUR/USD spot exchange rate, WTI Oil and Natural Gas over the time: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap06_pacf_plot_raw_series}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
...
\begin{frame}
    ...
    \begin{figure}
		\includegraphics[width=0.7\linewidth]{chap06_pacf_plot_log_diff.pdf}
		\caption{\tiny Figure: PACF values for daily observations (log first differences) of the EUR/USD spot exchange rate, WTI Oil and Natural Gas over the time: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap06_pacf_plot_log_diff}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{figure}
		\includegraphics[width=0.6\linewidth]{chap06_granger_causality_test_oil_raw_series.pdf}
		\caption{\tiny Figure: Granger causality test results testing granger causality of daily observations of oil for EUR/USD spot exchange rate over the time: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap06_granger_causality_test_oil_raw_series}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
...
\begin{frame}
    ...
    \begin{figure}
		\includegraphics[width=0.6\linewidth]{chap06_granger_causality_test_gas_raw_series.pdf}
		\caption{\tiny Figure: Granger causality test results testing granger causality of daily observations of gas for EUR/USD over the time: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap06_granger_causality_test_gas_raw_series}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
...
\begin{frame}
    ...
    \begin{figure}
		\includegraphics[width=0.6\linewidth]{chap06_granger_causality_test_oil_log_diff.pdf}
		\caption{\tiny Figure: Granger causality test results testing granger causality of daily observations (log first differences) of WTI Oil for EUR/USD over the time: 1999 - 2025.\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap06_granger_causality_test_oil_log_diff}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
