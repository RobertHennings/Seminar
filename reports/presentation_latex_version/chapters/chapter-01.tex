...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{\tiny Figure: Yearly oil consumption and production by country over the time: 1965 - 2024 (in terawatt-hours).\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap_01_yearly_oil_consumption_production_combined_graph}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%	NEW SLIDE
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{\tiny Figure: Yearly gas consumption and production by country over the time: 1965 - 2024 (in terawatt-hours).\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap_01_yearly_gas_consumption_production_combined_graph}}
	\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{\tiny Figure: Weekly open interest of oil and gas products over the time: 2000 - 2024\footnote{Own Illustration based on XYZ (2000), page 7 and data accessed 10.09.25.}\label{fig:chap_01_weekly_open_interest_oil_gas_combined_graph}}
	\end{figure}
\end{frame}