...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{\tiny Figure: Weekly open interest of oil and gas products over the time: 2000 - 2024\footnote{Own Illustration based on XX, page 11 and data taken from \cite{cftc_2025_commitments_of_traders}, last accessed 24.10.25.}\label{fig:chap_01_weekly_open_interest_oil_gas_combined_graph}}
	\end{figure}
\end{frame}